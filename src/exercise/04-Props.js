...
function CompanyProfile(props) {
     ...
     */
    const stockTicker = props.stockProps; //✏️ Instead of empty string we want to get this value from props
    const companyProfileInfo = props.companyProps; //✏️ Instead of empty object we want to get this value from props
    return (
        <div>
...
function FBCompanyProfile() {
     ...
     * */
    return (
        <CompanyProfile stockProps={stockTicker} companyProps={companyProfileInfo}/>
    )
}
